...
Calendar data is fetched from one or more Google Calendar **Secret iCal** feeds. This avoids a Google Cloud app, OAuth refresh tokens, and the retired Google Calendar XML feed.
